def validador(ruc):
    ...
    if len(ruc_limpio) != 14:       # Nueva linea...
        return False                # Nueva linea...
        
    if ruc_limpio.startswith("J"):  # Nueva linea...
        ...
        num_parte = (ruc_limpio[0:13])  # Extraer los 13 números del centro
        letra_original = ruc_limpio[13]
        ...
        letras_validas_natural = "ABCDEFGHJKLMNPQRSTUVWXY"
        
        # (Tomado de juridico). Validar contra la letra de control
        if letra_original == letras_validas_natural[posicion_letra]:
            return True
        else:
            return False
